...
class SsrSpider(scrapy.Spider):
    ...
    def parse_detail(self, response):
        ...
        movie_item["director"] = response.xpath("//p[@class='name text-center m-b-none m-t-xs']/text()").getall()
    ...
    def parse(self, response):
        for item in response.xpath("//div[@class='el-card item m-t is-hover-shadow']"):
            ...
            movie_item["rank"] = item.xpath(".//p[@class='score m-t-md m-b-n-sm']/text()").get()
