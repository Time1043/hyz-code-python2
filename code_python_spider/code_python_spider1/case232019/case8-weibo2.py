# -*- coding: utf-8 -*-
# @Author  : yingzhu
# @Time    : 2023/10/29 17:08
# @File    ：case8-weibo2.py
# @Function:
...
path = 'C:\\Users\\16654\\Desktop\\weibo\\'
                    ...
                    if (card_type == 9):
                        ...
                        if mblog.get('pics') != None:
                            ...
                            for _ in range(len(pic_archive)):
                                ...
                                img_filename = 'threebody'
                                f = open(path + weibo_name + '\\' + img_filename + str(pic_num) + str(imgurl[-4:]),
