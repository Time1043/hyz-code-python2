    ...
    while True:
        ...
        try:
            ...
            for hotel in hotels:
                ...
                hotels_info.append(
                    [num, hotel_name, hotel_price, hotel_rating, comments_count, hotel_address, href_value])
                num += 1
...
def timeout_handler(signum, frame):
    print("Script execution time exceeded 5 minutes, terminating.")
    exit(0)
...
if __name__ == '__main__':
    ...
    # signal.alarm(300)  # 设置定时器为 300 秒（5分钟）
