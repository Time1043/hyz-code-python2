...
def pretty_list(request):
    ...
    return render(request, 'pretty_list3.html', context)
...
def pretty_model_form_add(request):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'pretty_model_form_add3.html', {'form': form})
    # POST
    ...
    # 校验失败
    return render(request, 'pretty_model_form_add3.html', {'form': form})  # 显示错误信息
...
def pretty_model_form_edit(request, nid):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'pretty_model_form_edit3.html', {'form': form})
    # POST
